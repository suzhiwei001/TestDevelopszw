...
<link href="<%=basePath%>/resources/ManagementSystem/css/default.css" rel="stylesheet" type="text/css" />
...
<script src="<%=basePath%>/resources/json/json2.js"
	type="text/javascript"></script>
	<script type="text/javascript" src="<%=basePath%>/resources/ManagementSystem/js/outlook2.js"> </script>
</head>
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
	<noscript>
		<div
			style="position: absolute; z-index: 100000; height: 2046px; top: 0px; left: 0px; width: 100%; background: white; text-align: center;">
			<img src="<%=basePath%>/resources/images/blocks.gif" alt='抱歉，请开启脚本支持！' />
		</div>
	</noscript>
	<div region="north" split="true" border="false"
		style="overflow: hidden; height: 30px; background: url(<%=basePath%>/resources/images/layout-browser-hd-bg.gif) #7f99be repeat-x center 50%; line-height: 20px; color: #fff; font-family: Verdana, 微软雅黑, 黑体">
		<span style="float: right; padding-right: 20px;" class="head">欢迎
			管理员 <a href="#" id="editpass">修改密码</a> <a href="#" id="loginOut">安全退出</a>
		</span> <span style="padding-left: 10px; font-size: 16px;"><img
			src="<%=basePath%>/resources/images/blocks.gif" width="20" height="20" align="absmiddle" />项目管理系统</span>
	</div>
	...
	<script type="text/javascript">
	 ...
	 var _menus = {
		                 "menus":[
							      ...
							      "menus":[
									{"menuid":"12","menuname":"网页","icon":"icon-page","url":"<%=basePath%>/resources/ManagementSystem/menu1/treegrid.html"},
									{"menuid":"13","menuname":"类","icon":"icon-class","url":"<%=basePath%>/resources/ManagementSystem/menu1/class.html"},
									{"menuid":"14","menuname":"菜单","icon":"icon-role","url":"demo2.html"},
									{"menuid":"15","menuname":"菜单","icon":"icon-set","url":"demo.html"},
									{"menuid":"16","menuname":"菜单","icon":"icon-log","url":""}
								    ]},
						{"menuid":"8","icon":"icon-sys","menuname":"项目设计",
							"menus":[{"menuid":"21","menuname":"项目分析","icon":"icon-nav","url":"<%=basePath%>/resources/ManagementSystem/menu2/tree2.html"},
									{"menuid":"22","menuname":"菜单","icon":"icon-nav","url":"http://127.0.0.1:8086/suzhiwei-test/test?path=element"}
								]
